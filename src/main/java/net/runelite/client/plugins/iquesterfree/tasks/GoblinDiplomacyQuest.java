...
public class GoblinDiplomacyQuest extends Task {
    ...
    public List<ItemQuantity> requiredItems() {
        ...
        if (questProgress() == 0) {
            ...
            items.addAll(new TeleportMethod(game, TeleportLocation.VARROCK_CENTRE, 1).getItems());
        ...
        while (questProgress() < 6) {
            ...
            switch (questProgress()) {
                case 0:
                    ...
                    chatOptionalNpc(GOBLIN_VILLAGE, "General Bentnoze","Do you want me to pick an armour colour for you?", "What about a different colour?", "Yes.");
                    game.tick(5);
                    break;
                ...
                case 3:
                    ...
                    if (!game.inInstance()) {
                        iQuesterFreePlugin.status = "Chatting with Goblin General";
                        chatOptionalNpc(GOBLIN_VILLAGE, "General Bentnoze", "I have some orange armour here", "I have some blue armour here", "I have some brown armour here");
                    }
                    chatbox.chat();
                ...
                case 4:
                    if (!game.inInstance()) {
                        iQuesterFreePlugin.status = "Chatting with Goblin General";
                        chatOptionalNpc(GOBLIN_VILLAGE, "General Bentnoze", "I have some blue armour here", "I have some orange armour here", "I have some brown armour here");
                    }
                    chatbox.chat();
                    break;
                case 5:
                    if (!game.inInstance()) {
                        iQuesterFreePlugin.status = "Chatting with Goblin General";
                        chatOptionalNpc(GOBLIN_VILLAGE, "General Bentnoze", "I have some brown armour here", "I have some blue armour here", "I have some orange armour here");
                    }
                    chatbox.chat();
                    handleCompletion();
                    break;
